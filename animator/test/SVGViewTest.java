...
public class SVGViewTest {
  ...
  public void testTxtToSVG() {
    ...
    assertEquals("<svg width=\"700\" height=\"500\" version=\"1.1\"\n" +
        ...
        +
        "\t<animate attributeType=\"xml\" begin=\"1.0s\" dur=\"4.0s\" "
        + "attributeName=\"x\" from=\"200\" to=\"300\" fill=\"freeze\" />\n"
        +
        "\t<animate attributeType=\"xml\" begin=\"4.0s\" dur=\"10.0s\" "
        + "attributeName=\"width\" from=\"50\" to=\"20\" fill=\"freeze\" />\n"
        +
        "\t<animate attributeType=\"xml\" begin=\"4.0s\" dur=\"10.0s\" "
        + "attributeName=\"height\" from=\"100\" to=\"20\" fill=\"freeze\" />\n"
        +
        "\t<animate attributeType=\"xml\" begin=\"2.0s\" dur=\"5.0s\" "
        ...
        +
        "\t<animate attributeType=\"xml\" begin=\"0.0s\" dur=\"0.0s\" "
