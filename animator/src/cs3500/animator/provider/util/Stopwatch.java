...
public class Stopwatch {
  ...
  /**
   * Whether the Stopwatch has been paused... not actively counting but the start
  ...
  public void alterStartTime(double factor) {
    this.start = (long) (System.nanoTime() - (System.nanoTime() - start) * factor);
    this.pausedStart = (long) (System.nanoTime() - (System.nanoTime() - pausedStart) * factor);
  }
}