...
public class ShapeFactory {
   ...
   * Creates a rectangle.
   */
  public static IAnimatedShape getRectangle(String name, IPosition pos, RGBColor color,
   ...
   * Creates oval.
   */
  public static IAnimatedShape getOval(String name, IPosition pos, RGBColor color,
      float width, float height) {
